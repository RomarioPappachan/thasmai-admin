...
function NavLink() {
    ...
    return (
        <nav className='w-full h-full flex items-center'>
            ...
            <Link href = '/expenses/add-expense' className={`${pathname === '/expenses/add-expense' ? 'link px-5 py-1 bg-[#005DB8] text-white font-semibold rounded-lg' : 'link rounded-md px-5 py-1 bg-[#e0e2ec] text-black font-semibold hover:scale-105'}`}>Add Expense</Link>
            <Link href = '/expenses/reports' className={`${pathname === '/expenses/reports' ? 'link ms-3 px-5 py-1  bg-[#005DB8] text-white font-semibold rounded-lg' : 'link rounded-md ms-3 px-5 py-1 bg-[#e0e2ec] text-black font-semibold hover:scale-105'}`}>Reports</Link>
