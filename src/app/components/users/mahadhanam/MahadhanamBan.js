...
function MahadhanamBanUserPopup(props) {
console.log(props)
                ...
                <div className='w-full h-[50%] flex justify-evenly items-center'>
                    <button 
                        ...
                        onClick={() => {
                            (async function() {
                                try{
                                const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/superadmin/ban-User`, {
                                    UId: props.userId
                                });
...
export default MahadhanamBanUserPopup